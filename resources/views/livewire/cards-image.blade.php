							...
							<div class="card">
								...
								<div class="card-group p-5">
									<div class="card shadow-none border border-end-0 overflow-hidden">
										<img src="{{asset('build/assets/images/media/10.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
									...
									<div class="card shadow-none border border-end-0 overflow-hidden">
										<img src="{{asset('build/assets/images/media/11.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
											<h5 class="card-title">Card title</h5>
									...
									<div class="card shadow-none border overflow-hidden">
										<img src="{{asset('build/assets/images/media/12.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
											<h5 class="card-title">Card title</h5>
											<p class="card-text">This is a wider card with supporting text below as a
												natural
							...
							<div class="card">
								...
								<div class="card-group p-5">
									<div class="card  overflow-hidden shadow-none border border-end-0">
										<img src="{{asset('build/assets/images/media/13.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
											<h5 class="card-title">Card title</h5>
											<p class="card-text">This is a wider card with supporting text below as a
												natural
									...
									<div class="card  overflow-hidden shadow-none border border-end-0">
										<img src="{{asset('build/assets/images/media/14.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
											<h5 class="card-title">Card title</h5>
											<p class="card-text">This card has supporting text below as a natural lead-in to
												additional content.</p>
									...
									<div class="card overflow-hidden shadow-none border">
										<img src="{{asset('build/assets/images/media/15.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
											<h5 class="card-title">Card title</h5>
											<p class="card-text">This is a wider card with supporting text below as a
												natural
							...
							<div class="row">
								<div class="col-md-6 col-lg-4">
									<div class="card overflow-hidden">
										<img src="{{asset('build/assets/images/media/2.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
								...
								<div class="col-md-6 col-lg-4">
									<div class="card overflow-hidden">
										...
										<img src="{{asset('build/assets/images/media/1.jpg')}}" alt="image" class="card-image1 ">
									</div>
								</div>
								<div class="col-md-6 col-lg-4">
									<div class="card overflow-hidden">
										<img src="{{asset('build/assets/images/media/5.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
											<h5 class="card-title mb-3">Card title</h5>
											<p class="card-text">Some quick example text to build on the card title and make
												up
								...
								<div class="col-md-6 col-lg-4">
									<div class="card">
										...
										<img src="{{asset('build/assets/images/media/6.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
											<p class="card-text">Some quick example text to build on the card title and make
												up
												the bulk of the card's content.</p>
								...
								<div class="col-md-6 col-lg-4">
									<div class="card overflow-hidden">
										<img src="{{asset('build/assets/images/media/8.jpg')}}" alt="image" class="card-image1 ">
										<div class="card-body">
											<h5 class="card-title">Card title</h5>
								...
								<div class="col-md-12 col-xl-6">
									<div class="card card-blog-overlay2 border-0 overflow-hidden">
										<div class="card-body  text-white">
											<h3 class="card-title text-white">card-with image</h3>
											Duis aute irure dolor in reprehrighterit in voluptate velit esse cillum dolore
											eu
								...
								<div class="col-md-12 col-xl-6">
									<div class="card card-aside">
										<div class="card-body flex-column">
											...
											<div class="text-muted">Some quick example text to build on the card title and
												make
										...
										<a href="javascript:void(0);" class="card-aside-column br-te-7 br-be-7 w-50"
								...
								<div class="col-md-12 col-xl-6">
									<div class="card card-aside bg-primary">
										<div class="card-body flex-column">
											...
											<div class="text-white">Some quick example text to build on the card title and
												make
												up the bulk of the card's </div>
											<div class="d-flex align-items-center pt-5 mt-auto text-center ">
												<div class="text-muted">
										...
										<a href="javascript:void(0);" class="card-aside-column br-te-7 br-be-7 w-50"
											style="background-image: url({{asset('build/assets/images/media/20.jpg')}})"></a>
									</div>
								</div>
									...
									<div class="card ">
										<div class="card-header ">
											...
											<div class="card-options">
												<a href="javascript:void(0);" class="card-options-collapse me-2"
													data-bs-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
												<a href="javascript:void(0);" class="card-options-remove me-2"
													data-bs-toggle="card-remove"><i class="fe fe-x "></i></a>
											</div>
										</div>
										<div class="card-body text-center">
											<img src="{{asset('build/assets/images/users/16.jpg')}}" class="avatar avatar-xxl brround"
												alt="">
								...
								<div class="col-md-12 col-lg-6">
									<div class="card ">
										...
										<div class="card-body text-center">
											<img src="{{asset('build/assets/images/users/10.jpg')}}" class="avatar avatar-xxl brround"
												alt="">
