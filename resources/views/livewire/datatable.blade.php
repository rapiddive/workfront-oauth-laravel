                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <button id="button"
                                                            class="btn btn-primary mb-4 datadelete-table-btn">Delete
                                                            selected
                                                            row</button>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive datatble-filter">
                                                <table id="example4"
                                                    class="table card-table table-vcenter text-nowrap border p-0">
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
                                                            <th>Position</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="display:none">
                                                            <td colspan="6">
                                                                <div>
                                                                    <div
                                                                        class="panel panel-primary receipts-inline-table border-0">
...
@section('scripts')
        ...
        <script src="{{asset('build/assets/plugins/datatables/JSZip/jszip.min.js')}}"></script>
        <script src="{{asset('build/assets/plugins/datatables/pdfmake/pdfmake.min.js')}}"></script>
        <script src="{{asset('build/assets/plugins/datatables/pdfmake/vfs_fonts.js')}}"></script>
