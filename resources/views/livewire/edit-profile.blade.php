                                ...
                                <div class="col-xl-3 col-lg-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-footer text-end">
                                            <a href="javascript:void(0);" class="btn btn-success mb-1">Updated</a>
                                            <a href="javascript:void(0);" class="btn btn-danger mb-1">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Home Address"
                                                            value="3rd Lane,4th Phase,Street no-4 California">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="https://www.facebook.com/" value="PatrennaSchell">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="https://twitter.com/" value="PatrennaSchell">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="https://in.pinterest.com/" value="PatrennaSchell">
                                                    </div>
                                                </div>
                                            </div>
