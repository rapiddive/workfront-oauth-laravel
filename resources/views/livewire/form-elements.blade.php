                                        ...
                                        <div class="card-body pb-2">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                                    <input class="form-control mb-4" placeholder="Input box (readonly)"
                                                        readonly="" type="text">
                                                </div>
                                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                                    <input class="form-control mb-4" disabled=""
                                                        placeholder="Input box (disabled)" type="text">
                                                </div>
                                            </div>
                                            <div class="row row-sm">
                                                <div class="col-lg">
                                                ...
                                                <div class="col-lg mg-t-10">
                                                    <textarea class="form-control mb-4" disabled=""
                                                        placeholder="Texarea (disabled)" rows="3"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <input class="form-control  mb-4 is-valid state-valid"
                                                                placeholder="Input box (success state)" required=""
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <input class="form-control mb-4 is-invalid state-invalid"
                                                                placeholder="Input box (invalid state)" required=""
                                                                type="text">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-9 col-lg-8 mb-0">
                                                    <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <label class="form-label">CVV
                                                                        <span class="form-help m-0 ms-1" data-bs-toggle="tooltip"
