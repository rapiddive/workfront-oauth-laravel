...
@section('content')
							...
							<div class="page-header">
								<div class="page-leftheader">
									<h4 class="page-title mb-0 text-primary">Material Svgs</h4>
								</div>
								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-header">
											<h3 class="card-title">Material Filled Icons</h3>
										</div>
										<div class="card-body">
											<div class="row">
												<div class="col-sm-12 col-lg-12">
													<div class="icons-list-wrap">
														<ul class="icons-list">
															<li class="icons-list-item"><svg class="svg-icon"
															...
															<li class="icons-list-item"><svg class="svg-icon"
																	xmlns="http://www.w3.org/2000/svg" height="24"
																	viewBox="0 0 24 24" width="24">
																	<path clip-rule="evenodd" d="M0 0h24v24H0z"
																		fill="none" />
																	<path
												...
												<div class="col-lg-12 col-sm-12 mb-4">
													<p class="mb-0 mt-5">Simply beautiful open source icons. For more Icons
									...
									<div class="card">
										<div class="card-header">
											<h3 class="card-title">Material Outlined Icons</h3>
										</div>
										<div class="card-body">
											<div class="row">
												<div class="col-sm-12 col-lg-12">
									...
									<div class="card">
										<div class="card-header">
											<h3 class="card-title">Material Two Toned Icons</h3>
										</div>
										<div class="card-body">
											<div class="row">
												<div class="col-sm-12 col-lg-12">
