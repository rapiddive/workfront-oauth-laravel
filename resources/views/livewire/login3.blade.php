                                                                                        ...
                                                                                        <div class="card bg-primary text-white br-7 p-2">
                                                                                                <div class="card-body mb-0">
                                                                                                        ...
                                                                                                        <form>
                                                                                                                ...
                                                                                                                <div class="form-group">
                                                                                                                        <label class="custom-control custom-checkbox">
                                                                                                                                ...
                                                                                                                                <span class="custom-control-label text-white-50">Remember Me <a
                                                                                                                                                href="{{url('forgot-password3')}}"
                                                                                                                                                class="btn-link text-white float-end ms-2">Forget password
                                                                                                                                                ?</a></span>
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                                <div class="col-12">
                                                                                                                        <a href="{{url('index')}}"
                                                                                                                                class="btn btn-white text-primary btn-block d-grid px-4 font-weight-bold">Log
                                                                                                                                In</a>
                                                                                                                </div>
                                                                                                        </div>
                                                                                                        <div class="text-center pt-4">
                                                                                                                <div class="font-weight-normal fs-14 text-white-50">Don't have an
                                                                                                                        account ? <a class="btn-link font-weight-bold anchors text-white"
                                                                                                                                href="{{url('register3')}}">Sign Up</a></div>
                                                                                                        </div>
                                                                                                </div>
                                                                                        </div>
                                                                                </div>
