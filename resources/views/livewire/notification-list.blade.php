...
@section('content')
                            ...
                            <div class="page-header">
                                <div class="page-leftheader">
                                    <h4 class="page-title mb-0 text-primary">Notification list</h4>
                                </div>
                            ...
                            <div class="container">
                                <ul class="notification">
                                    <li>
                                        ...
                                        <div class="notification-time-date mb-2">
                                            <span class="date">Today</span>
                                        ...
                                        <div class="notification-body">
                                            <div class="media mt-0">
                                                <div class="main-avatar avatar-md online">
                                                    <img alt="avatar" class="br-7" src="{{asset('build/assets/images/users/1.jpg')}}">
                                                </div>
                                            ...
                                            <div class="media mt-0">
                                                ...
                                                <div class="media-body ms-3 d-flex">
                                                    <div>
                                                        ...
                                                        <p class="mb-0 fs-13 text-dark">Created New Template for Designing
                                                            Department.</p>
                                                    </div>
                                                    <div class="notify-time">
                                    ...
                                    <li>
                                        ...
                                        <div class="notification-body">
                                            <div class="media mt-0">
                                                <div class="main-avatar avatar-md online">
                                                    <img alt="avatar" class="br-7" src="{{asset('build/assets/images/users/2.jpg')}}">
                                                </div>
                                                <div class="media-body ms-3 d-flex">
                                                    <div>
                                                        <p class="fs-15 text-dark fw-bold mb-0">Elida Distefa<span
                                                                class="badge bg-success ms-3 px-2 pb-0 mb-1 d-sm-inline-flex d-none">New Deal</span>
                                                        </p>
                                    ...
                                    <li>
                                        ...
                                        <div class="notification-time-date mb-2">
                                            <span class="date">23 Oct</span>
                                            <span class="time ms-2 d-inline-block">03:15</span>
                                        </div>
                                        <div class="notification-body">
                                            <div class="media mt-0">
                                                <div class="main-avatar avatar-md online">
                                                    <img alt="avatar" class="br-7" src="{{asset('build/assets/images/users/12.jpg')}}">
                                                </div>
                                                <div class="media-body ms-3 d-flex">
                                                    <div>
                                    ...
                                    <li>
                                        ...
                                        <div class="notification-time-date mb-2">
                                            <span class="date">15 Oct</span>
                                            <span class="time ms-2 d-inline-block">12:14</span>
                                        </div>
                                        <div class="notification-body">
                                            <div class="media mt-0">
                                                <div class="main-avatar avatar-md offline">
                                    ...
                                    <li>
                                        ...
                                        <div class="notification-time-date mb-2">
                                            <span class="date">30 Sep</span>
                                            <span class="time ms-2 d-inline-block">14:04</span>
                                        </div>
                                        <div class="notification-body">
                                            <div class="media mt-0">
                                                <div class="main-avatar avatar-md offline">
                                                    <img alt="avatar" class="br-7" src="{{asset('build/assets/images/users/13.jpg')}}">
                                                </div>
                                                <div class="media-body ms-3 d-flex">
                                                    <div>
                                                        <p class="fs-15 text-dark fw-bold mb-0">Mercy Ritia<span
                                                                class="badge bg-danger ms-3 px-2 pb-0 mb-1 d-sm-inline-flex d-none">Last Deal</span>
                                                        </p>
                                                        <p class="mb-0 fs-13 text-dark">Created New Template for Designing
                                                            Department.</p>
                                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="notification-time-date mb-2">
                                            <span class="date">18 Sep</span>
                                            <span class="time ms-2 d-inline-block">12:26</span>
                                        </div>
                                        <div class="notification-body">
                                            <div class="media mt-0">
                                                <div class="main-avatar avatar-md online">
                                                    <img alt="avatar" class="br-7" src="{{asset('build/assets/images/users/4.jpg')}}">
                                                </div>
                                                <div class="media-body ms-3 d-flex">
                                                    <div>
                                    ...
                                    <li>
                                        ...
                                        <div class="notification-time-date mb-2">
                                            <span class="date">03 Sep</span>
                                            <span class="time ms-2 d-inline-block">05:37</span>
                                        </div>
                                        <div class="notification-body">
                                            <div class="media mt-0">
                                                <div class="main-avatar avatar-md offline">
                                                    <img alt="avatar" class="br-7" src="{{asset('build/assets/images/users/14.jpg')}}">
                                                </div>
                                                <div class="media-body ms-3 d-flex">
                                                    <div>
                                                        <p class="fs-15 text-dark fw-bold mb-0">Benedict Vallone</p>
                                                        <p class="mb-0 fs-13 text-dark">Thanking you for Accepting Request.
                                                        </p>
                                                    </div>
                                                    <div class="notify-time">
                                    ...
                                    <li>
                                        ...
                                        <div class="notification-time-date mb-2">
                                            <span class="date">28 Aug</span>
                                            <span class="time ms-2 d-inline-block">15:24</span>
                                        </div>
                                        <div class="notification-body">
                                            <div class="media mt-0">
                                                <div class="main-avatar avatar-md online">
